...
def spread_draws(
    posteriors: dict[str, np.ndarray], variable_names: Iterable[str]
) -> pl.DataFrame:
    """
    ...
    variable_names
        list of strings or of tuples identifying which variables to
        retrieve.

    Returns
    -------
    pl.DataFrame
        Polars dataframe with the spread draws
    """
